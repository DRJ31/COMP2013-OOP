public class Student {
    ...
    public Student(int ID, String name) {//Initialize the student with ID and name
    ...
    public Student(int ID, String name, char grade){//Initialize the student with ID, name and grade
        if (ID <= 0)//Check if the ID is valid
            this.ID = 0;
        else
            this.ID = ID;
    ...
    public int getID() {//Get the ID of this student
        return ID;
    }
    ...
    public static void TestStudent() {
    	...
    	stu2.goToSleep();//Let student2 go to sleep
    	System.out.println(stu1.isSleeping() == false);//Check if student1 is sleeping
    	System.out.println(stu2.isSleeping() == true);//Check if student2 is sleeping
    	System.out.println(stu2.getGrade() == 'D');//Check if student2's grade has decreased
    	stu2.wakeUp();//Wake up student2
    	System.out.println(stu2.isSleeping() == false);//Check if student2 is still sleeping
    	System.out.println(stu2.getGrade() == 'D');//Check if student2's grade has changed after wake up
    }
}